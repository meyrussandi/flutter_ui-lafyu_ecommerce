...
class BorderStyles {
  ...
  static OutlineInputBorder enableTextField = OutlineInputBorder(
    borderSide:
    BorderSide(color: MyColors.greyColor, width: Strokes.xthin),
  ...
  static OutlineInputBorder disableTextField = OutlineInputBorder(
    borderSide:
    BorderSide(color: MyColors.lightColor, width: Strokes.xthin),
    borderRadius: Corners.lgBorder,
  );
...
InputDecoration inputDecoration(
  ...
  return InputDecoration(
      ...
      hintStyle: TextStyles.body2.copyWith(color: MyColors.lightColor));
}
